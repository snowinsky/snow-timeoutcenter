...
public class LuaJedisHandleQueue extends HandleQueue {
    ...
    public LuaJedisHandleQueue(HandleFactory handleFactory, DeadLetterQueue deadLetterQueue, JedisPool pool, String bizTag, int slotNumber) {
